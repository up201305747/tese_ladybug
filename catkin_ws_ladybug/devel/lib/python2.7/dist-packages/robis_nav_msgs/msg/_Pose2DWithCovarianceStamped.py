...
"""autogenerated by genpy from robis_nav_msgs/Pose2DWithCovarianceStamped.msg. Do not edit."""
import sys
...
class Pose2DWithCovarianceStamped(genpy.Message):
  _md5sum = "ab0768bc4ea39653299e7f1d78db7fc2"
  _type = "robis_nav_msgs/Pose2DWithCovarianceStamped"
...
float64 theta"""
  ...
  _slot_types = ['std_msgs/Header','geometry_msgs/Pose2D','float64[9]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Pose2DWithCovarianceStamped, self).__init__(*args, **kwds)
